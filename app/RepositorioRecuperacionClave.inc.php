    ...
    public static function generar_peticion($conexion, $id_usuario, $url_secreta){
        ...
        if(isset($conexion)){
            try{
                ...
                $sql = "INSERT INTO recuperacion_clave(usuario_id, url_secreta, fecha) VALUES (:usuario_id, 
                        :url_secreta, NOW())";
                $sentencia = $conexion -> prepare($sql);
                
                $sentencia -> bindParam(':usuario_id', $id_usuario, PDO :: PARAM_SRT);
                $sentencia -> bindParam(':url_secreta', $url_secreta, PDO :: PARAM_SRT);     
